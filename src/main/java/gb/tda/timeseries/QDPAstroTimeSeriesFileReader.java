...
public class QDPAstroTimeSeriesFileReader extends AsciiTimeSeriesFileReader {
    
    private static final Logger logger = Logger.getLogger(QDPAstroTimeSeriesFileReader.class);
