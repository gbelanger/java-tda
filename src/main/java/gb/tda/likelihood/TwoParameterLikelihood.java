...
public abstract class TwoParameterLikelihood extends Likelihood {
    ...
    public double getLikelihood(double par1Value, double par2Value,  int[] data) {
		return getLikelihood(par1Value, par2Value, PrimitivesConverter.int2double(data));
    }
    ...
    public double getLogLikelihood(double par1Value, double par2Value, int[] data) {
		return getLogLikelihood(par1Value, par2Value, PrimitivesConverter.int2double(data));
    }
    ...
    public double getNegLogLikelihood(double par1Value, double par2Value, int[] data) {
		return getNegLogLikelihood(par1Value, par2Value, PrimitivesConverter.int2double(data));
    }
    

    //  Log-Likelihood of model
    public double getLogLikelihoodOfModel(double[] modelPar1Values, double[] modelPar2Values, double[] data) throws IllegalArgumentException {
		Utils.checkArrayLengthsAreEqual(modelPar1Values, data);
		Utils.checkArrayLengthsAreEqual(modelPar2Values, data);
    ...
    public double getNegLogLikelihoodOfModel(double[] modelPar1Values, double[] modelPar2Values, double[] data) throws IllegalArgumentException {
    ...
    public double[] getLikelihoodFunction(double[] par1Values, double par2FixedValue, int[] data) {
		return getLikelihoodFunction(par1Values, par2FixedValue, PrimitivesConverter.int2double(data));
    }

    public double[] getLikelihoodFunction(double par1FixedValue, double[] par2Values, int[] data) {
		return getLikelihoodFunction(par1FixedValue, par2Values, PrimitivesConverter.int2double(data));
    }
