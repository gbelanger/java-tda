...
public abstract class OneParameterLikelihood extends Likelihood {
    ...
    abstract double getLogLikelihoodOfModel(double[] model, double[] data) throws BinningException;
    ...
    public double getLikelihood(double parameterValue, int[] data) {
	return getLikelihood(parameterValue, Converter.int2double(data));
    }
    ...
    public double[] getLikelihoodFunction(double[] parameterValues, int[] data) {
	return getLikelihoodFunction(parameterValues, Converter.int2double(data));
    }
    ...
    public double[] getLikelihoodFunction(double minParameterValue, double maxParameterValue, int[] data) {
	return getLikelihoodFunction(minParameterValue, maxParameterValue, Converter.int2double(data));
    }
